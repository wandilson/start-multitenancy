                ...
                <form method="POST" wire:submit.prevent="store">
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-1/4 px-3 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-1" wire:model="name" type="text" placeholder="RH">
                        ...
                        <div class="md:w-3/4 px-3">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-1" wire:model="label" type="text" placeholder="Gerencia Atividades do RH">
